...
namespace Parkin.Api.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260825183726_AddAccessEventAndParkingSession")]
    partial class AddAccessEventAndParkingSession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Parkin.Api.Domain.AccessEventAggregate.AccessEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("MatchedPlateId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("OverrideOf")
                        .HasColumnType("uuid");

                    b.Property<string>("RawPlate")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
            ...
            modelBuilder.Entity("Parkin.Api.Domain.ParkingSessionAggregate.ParkingSession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("LotId", "Plate")
                        .HasDatabaseName("ix_session_active_lot_plate")
                        .HasFilter("\"Status\" = 'Active'");

                    b.HasIndex("LotId", "Pool")
